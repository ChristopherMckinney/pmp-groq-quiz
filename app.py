...
if st.session_state.question_data:
    ...
    if st.session_state.show_result and selected:
        ...
        st.markdown(f"**Score:** {st.session_state.score} out of {st.session_state.total} correct this session.")

# --- Footer Disclaimer ---
st.markdown("""
    <hr style='margin-top:50px;'>
    <div style='text-align:center; font-size:0.85rem; color:#666;'>
        This AI-generated tool is for practice purposes only. This tool is not affiliated with or endorsed by PMI®.
    </div>
""", unsafe_allow_html=True)
